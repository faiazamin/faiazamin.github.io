...
- 🏅 **Samsung A2 Patent Grade**  
  Acoustic signal–based input mechanism for headless wearables  
  → Pending patent filing at KIPO

- 🏅 **Samsung A1 Patent Grade**  
  Computer vision–based perspective distortion correction for mobile photography

- 🌟 **Samsung AI POC Exhibition (SRBD)**  
  Activity-based health insight recommendation for Galaxy Watch + phone
...
- 🎖️ Prestigious **Mobile R&D CTO Award** (Samsung R&D Institute Bangladesh)  
  [Certificate]({{ "/assets/img/CTO Certificate.png" | relative_url }})
- 🏅 **Excellence Award — Samsung R&D Institute Bangladesh** (Apr–Jun 2023) · Ref: 01371  
  [Certificate]({{ "/assets/img/Certificate for Faiaz Amin Khan 01371.png" | relative_url }})
- 🏅 **Excellence Award — Samsung R&D Institute Bangladesh** (Oct–Dec 2023) · Ref: 01469  
...
- 🎓 Undergraduate Thesis  
  *“Deep Learning Approach to Solving the Travelling Salesman Problem with Hardness-Adaptive Curriculum”*  
  Presented at the **University of Dhaka Annual Thesis Poster Presentation Competition**.
