...
- Ideated and implemented the proof of concept for context aware and activity-based personal health information recommendation system for Samsung Galaxy watches
...
## Publications & Patent
**Method For AI Based Distortion Correction In Photography** (_A1 patent grade_, _Pending filing at KIPO, USPTO_)
...
**Deep Learning Approach to Solving the Travelling Salesman Problem with Hardness-Adaptive Curriculum** (_Final Year Poster Presentation Compitition, University of Dhaka_)
